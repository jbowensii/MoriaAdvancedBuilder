...
// F12 panel: 1540px width, wLeft corrected for alignment, Environment tab grouped by bubble with icon click narrowed to 64px
        ...
        // before discovering the in-game modal asset is never loaded:
        // v6.21.12 UClass scan returns 0 matches for Rename/Modal in the
        // user session. The in-game modal path was a phantom; rename has
        // been firing the legacy popup all along since v6.20.30.
        // showRenameDialog_v2 still attempts the in-game modal first; on
        // failure it falls back to this legacy home-rolled UMG popup.
