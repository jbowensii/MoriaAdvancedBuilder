// MoriaCppMod v6.23.5 - Return to Moria UE4SS C++ mod (~15,500 lines after v6.23.5 Pass 2 cleanup)
...
namespace MoriaMods
{
    ...
    class MoriaCppMod : public RC::CppUserModBase
    {
      private:
        ...
        // v6.23.5 - The controller cluster (~720 LOC: DualSenseReader +
      ...
      public:
        ...
        MoriaCppMod()
        {
            ...
            VLOG(STR("[MoriaCppMod] Loaded v6.23.5\n"));
        }
        ...
        auto on_unreal_init() -> void override
        {
            ...
            loadConfig();
            VLOG(STR("[MoriaCppMod] Loaded v6.23.5 (workDir={})\n"),
            ...
            Unreal::Hook::RegisterProcessEventPreCallback([](UObject* context, UFunction* func, void* parms) {
                ...
                // v6.22.5+v6.23.5: appendCheatsTabToArray call removed from
                ...
                // (v6.22.4+v6.23.5: PE pre-hook gamepad suppression and
            ...
            m_replayActive = true;
            VLOG(
                    STR("[MoriaCppMod] v6.23.5: F1-F8=build | F9=rotate | F12=config | Num0=bubble info | Num*=reveal map | Mod keybinds in Settings → keymap tab\n"));
            ...
            Unreal::Hook::RegisterLoadMapPreCallback(
                [this](UEngine*, FWorldContext&, FURL, UPendingNetGame*, FString&) -> std::pair<bool, bool>
                {
                    ...
                    //  v6.23.5 along with the rest of the FGK runtime-injection
        ...
        // (v6.23.5: FGK runtime-injection diagnostics deleted -
